...
Partial Public Class Database1DataSet
    ...
    Partial Public Class EmployeeDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddEmployeeRow(ByVal Id As Integer, ByVal FirstName As String, ByVal LastName As String) As EmployeeRow
            Dim rowEmployeeRow As EmployeeRow = CType(Me.NewRow,EmployeeRow)
            Dim columnValuesArray() As Object = New Object() {Id, FirstName, LastName}
...
Namespace Database1DataSetTableAdapters
    ...
    Partial Public Class EmployeeTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employee] WHERE (([Id] = @Original_Id) AND ([FirstName] = @Ori"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([Id], [FirstName], [LastName]) VALUES (@Id, @FirstN"& _ 
                "ame, @LastName);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, FirstName, LastName FROM Employee WHERE (Id = @Id)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Employee] SET [Id] = @Id, [FirstName] = @FirstName, [LastName] = @L"& _ 
                "astName WHERE (([Id] = @Original_Id) AND ([FirstName] = @Original_FirstName) AND"& _ 
                " ([LastName] = @Original_LastName));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, FirstName, LastName FROM Employ"& _ 
                "ee WHERE (Id = @Id)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.exam2review.My.MySettings.Default.Database1ConnectionString
        End Sub
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As Database1DataSet.EmployeeDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As Database1DataSet.EmployeeDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As Database1DataSet.EmployeeDataTable = New Database1DataSet.EmployeeDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As Database1DataSet.EmployeeDataTable) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Id As Integer, ByVal FirstName As String, ByVal LastName As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Id As Integer, ByVal FirstName As String, ByVal LastName As String, ByVal Original_Id As Integer, ByVal Original_FirstName As String, ByVal Original_LastName As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal FirstName As String, ByVal LastName As String, ByVal Original_Id As Integer, ByVal Original_FirstName As String, ByVal Original_LastName As String) As Integer
            Return Me.Update(Original_Id, FirstName, LastName, Original_Id, Original_FirstName, Original_LastName)
        End Function
    End Class
